...
- [**Data Analytics Portfolio**]([link-to-code](https://github.com/nn-projects/flick-strategy-project/blob/main/data.html) - R scripts and Excel models used in analysis  
